...
public enum KnownSimQueue
{
  ...
  // composite
  ENCAPSULATOR   ("Encapsulator", true, nl.jdj.jqueues.r5.entity.queue.composite.tandem.BlackEncapsulatorSimQueue.class,
                  GeneratorProfile.SE_Q_DSJF,
                  IntegerParameterProfile.IPP_IRRELEVANT,
                  IntegerParameterProfile.IPP_ALWAYS_INFINITE,
                  DoubleParameterProfile.DPP_IRRELEVANT),
  DROP_COLLECTOR ("DropCollector", true, nl.jdj.jqueues.r5.entity.queue.composite.collector.BlackDropCollectorSimQueue.class,
                  GeneratorProfile.SE_Q1_Q2_DSJF,
                  IntegerParameterProfile.IPP_IRRELEVANT,
                  IntegerParameterProfile.IPP_ALWAYS_INFINITE,
                  DoubleParameterProfile.DPP_IRRELEVANT),
  TANDEM         ("Tandem", true, nl.jdj.jqueues.r5.entity.queue.composite.tandem.BlackTandemSimQueue.class,
                  GeneratorProfile.SE_QSET_DSJF,
                  IntegerParameterProfile.IPP_IRRELEVANT,
                  IntegerParameterProfile.IPP_ALWAYS_INFINITE,
                  DoubleParameterProfile.DPP_IRRELEVANT),
  COMP_TANDEM_2  ("Comp_Tandem_2", true, nl.jdj.jqueues.r5.entity.queue.composite.tandem.BlackCompressedTandem2SimQueue.class,
                  GeneratorProfile.SE_Q1_Q2_DSJF,
                  IntegerParameterProfile.IPP_IRRELEVANT,
                  IntegerParameterProfile.IPP_ALWAYS_INFINITE,
                  DoubleParameterProfile.DPP_IRRELEVANT),
  PARALLEL       ("Parallel", true, nl.jdj.jqueues.r5.entity.queue.composite.parallel.BlackParallelSimQueues.class,
                  GeneratorProfile.UNKNOWN,
                  IntegerParameterProfile.IPP_IRRELEVANT,
                  IntegerParameterProfile.IPP_ALWAYS_INFINITE,
                  DoubleParameterProfile.DPP_IRRELEVANT),
  JSQ            ("JSQ", true, nl.jdj.jqueues.r5.entity.queue.composite.parallel.BlackJoinShortestSimQueue.class,
                  GeneratorProfile.SE_QSET_DSJF_OWJ_RNG,
                  IntegerParameterProfile.IPP_IRRELEVANT,
                  IntegerParameterProfile.IPP_ALWAYS_INFINITE,
                  DoubleParameterProfile.DPP_IRRELEVANT),
  FB_PROB        ("FB_Prob", true, nl.jdj.jqueues.r5.entity.queue.composite.single.feedback.BlackProbabilisticFeedbackSimQueue.class,
                  GeneratorProfile.SE_Q_PFB_RNG_DSJF,
                  IntegerParameterProfile.IPP_IRRELEVANT,
                  IntegerParameterProfile.IPP_ALWAYS_INFINITE,
                  DoubleParameterProfile.DPP_IRRELEVANT),
  FB_VISITS      ("FB_NumVisits", true, nl.jdj.jqueues.r5.entity.queue.composite.single.feedback.BlackNumVisitsFeedbackSimQueue.class,
                  GeneratorProfile.SE_Q_NUMV_DSJF,
                  IntegerParameterProfile.IPP_IRRELEVANT,
                  IntegerParameterProfile.IPP_ALWAYS_INFINITE,
                  DoubleParameterProfile.DPP_IRRELEVANT),
  JACKSON        ("Jackson", true, nl.jdj.jqueues.r5.entity.queue.composite.jackson.BlackJacksonSimQueueNetwork.class,
                  GeneratorProfile.UNKNOWN,
                  IntegerParameterProfile.IPP_IRRELEVANT,
                  IntegerParameterProfile.IPP_ALWAYS_INFINITE,
                  DoubleParameterProfile.DPP_IRRELEVANT),
