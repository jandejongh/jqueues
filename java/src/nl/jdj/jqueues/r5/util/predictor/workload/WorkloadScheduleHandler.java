...
/** A handler for specific {@link SimEntityEvent} types as extension to a {@link DefaultWorkloadSchedule}.
 * 
 * <p>
 ...
 * accompanying {@link SimEntityEvent}s, especially for queues with multiple state extensions
...
public interface WorkloadScheduleHandler
{
  ...
  /** Gets the set of {@link SimEntityEvent}s of this handler, and the {@link SimEntitySimpleEventType} members onto which they
   *  map.
   * 
   * <p>
   * The key-set should contains unique {@link SimEntityEvent}s within the realm of the {@link DefaultWorkloadSchedule}
   * at which this handler registers.
   * Likewise, the values should be unique.
   * 
   * @return The set of {@link SimEntityEvent}s of this handler, and the {@link SimEntitySimpleEventType} members onto which they
   *         map.
   * 
   */
  public Map<Class<? extends SimEntityEvent>, SimEntitySimpleEventType.Member> getEventMap ();
