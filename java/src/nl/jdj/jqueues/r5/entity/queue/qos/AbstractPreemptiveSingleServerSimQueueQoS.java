...
import nl.jdj.jqueues.r5.entity.queue.preemptive.AbstractPreemptiveSingleServerSimQueue;
 ...
 * 
 */
public abstract class AbstractPreemptiveSingleServerSimQueueQoS
  <J extends SimJob, Q extends AbstractPreemptiveSingleServerSimQueueQoS, P extends Comparable>
  ...
  implements SimQueueQoS<J, Q, P>
{
  ...
  /** Creates a non-preemptive single-server queue with explicit QoS support given an event list.
   *
   ...
   *
   */
  protected AbstractPreemptiveSingleServerSimQueueQoS
