...
import nl.jdj.jqueues.r4.util.predictor.queues.SimQueuePredictor_NoBuffer_c;
...
public class NoBuffer_cTest
{
  ...
  public void testNoBuffer_c () throws SimQueuePredictionException
  {
    ...
    for (final int c : cValues)
    {
      ...
      final SimQueuePredictor<DefaultVisitsLoggingSimJob, SimQueue> predictor = new SimQueuePredictor_NoBuffer_c<> (c);
