...
import nl.jdj.jqueues.r5.entity.queue.nonpreemptive.*;
...
public class EncTest
{
  ...
  public void testEnc () throws SimQueuePredictionException
  {
    ...
    for (final double waitingTime : waitingTimeValues)
    {
      ...
      DefaultSimQueueTests.doSimQueueTests_SQ_SV (enc_delay, predictor_enc_delay, numberOfJobs, silent, deadSilent, 1.0e-12, null);
    }
    // Enc[DROP]
    ...
    DefaultSimQueueTests.doSimQueueTests_SQ_SV (enc_drop, predictor_enc_drop, numberOfJobs, silent, deadSilent, 1.0e-12, null);
    // Enc[SINK]
    ...
    DefaultSimQueueTests.doSimQueueTests_SQ_SV (enc_sink, predictor_enc_sink, numberOfJobs, silent, deadSilent, 1.0e-12, null);
    // Enc[ZERO]
    ...
    DefaultSimQueueTests.doSimQueueTests_SQ_SV (enc_zero, predictor_enc_zero, numberOfJobs, silent, deadSilent, 1.0e-12, null);
    // Enc[FCFS]
    ...
    DefaultSimQueueTests.doSimQueueTests_SQ_SV (enc_fcfs, predictor_enc_fcfs, numberOfJobs, silent, deadSilent, 1.0e-12, null);
//    // XXX Does not pass!
//    // Enc[Enc[Enc[FCFS]]]
//    final FCFS fcfs2 = new FCFS (eventList);
//    final SimQueuePredictor predictor_fcfs2 = new SimQueuePredictor_FCFS ();
//    final BlackEncapsulatorSimQueue enc_fcfs2 = new BlackEncapsulatorSimQueue (eventList, fcfs, null);
//    final BlackEncapsulatorSimQueue enc_enc_fcfs2 = new BlackEncapsulatorSimQueue (eventList, enc_fcfs2, null);
//    final BlackEncapsulatorSimQueue enc_enc_enc_fcfs2 = new BlackEncapsulatorSimQueue (eventList, enc_enc_fcfs2, null);
//    final SimQueuePredictor_Enc predictor_enc_enc_enc_fcfs2 = new SimQueuePredictor_Enc (predictor_fcfs2);
//    DefaultSimQueueTests.doSimQueueTests_SQ_SV
//      (enc_enc_enc_fcfs2, predictor_enc_enc_enc_fcfs2, numberOfJobs, silent, deadSilent, 1.0e-12, null);
//    // XXX Leads to ambiguity.
//    // Enc[FCFS_B]
...
//      DefaultSimQueueTests.doSimQueueTests_SQ_SV (enc_queue, predictor_enc_queue, numberOfJobs, silent, deadSilent, 1.0e-12, null);
//    }
//    // XXX Leads to ambiguity.
//    // Enc[LCFS]
...
//    DefaultSimQueueTests.doSimQueueTests_SQ_SV (enc_lcfs, predictor_enc_lcfs, numberOfJobs, silent, deadSilent, 1.0e-12, null);
//    // XXX Leads to ambiguity.
//    // Enc[P_LCFS]
...
//    DefaultSimQueueTests.doSimQueueTests_SQ_SV (enc_p_lcfs, predictor_enc_p_lcfs, numberOfJobs, silent, deadSilent, 1.0e-12, null);
    // Enc[PS]
    ...
    DefaultSimQueueTests.doSimQueueTests_SQ_SV (enc_ps, predictor_enc_ps, numberOfJobs, silent, deadSilent, 1.0e-12, null);
  }
