...
import org.javades.jqueues.r5.util.predictor.queues.SimQueuePredictor_LCFS_B;
...
public class LCFS_BTest
{
   ...
   */
  @Test
  public void testLCFS_B () throws SimQueuePredictionException
  {
    ...
    {
      final LCFS_B queue = new LCFS_B (eventList, B);
      final SimQueuePredictor predictor = new SimQueuePredictor_LCFS_B (B);
