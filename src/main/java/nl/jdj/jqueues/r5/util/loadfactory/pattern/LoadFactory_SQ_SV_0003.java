...
/** A concrete {@link LoadFactory_SQ_SV}, pattern 0003.
 *
 * @see #generate
 * 
 ...
 * 
 */
public class LoadFactory_SQ_SV_0003<J extends SimJob, Q extends SimQueue>
extends AbstractLoadFactory_SQ_SV<J, Q>
{
  ...
  {
    return "A single job with unity index and infinite requested service time arriving at t=0.";
  }

  /** Creates a suitable map for the requested service time for a job visit to a queue.
   * 
   * <p>
   * A job with zero index and infinite requested service time is returned.
   * 
  ...
  protected Map<Q, Double> generateRequestedServiceTimeMap (final Q queue)
  {
    ...
    requestedServiceTimeMap.put (queue, Double.POSITIVE_INFINITY);
